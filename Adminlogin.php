...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">TRIP OF ALIFE TIME</a></h1>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      ...
      <div class="container" data-aos="fade-up">  
       <div class="section-title">
          ...
          <h2>Admin LOG IN</h2>
          <p>This page for Admins Only where they can check and update the Website</p>
        </div>
...
$admin_id= $admin->check_login($connection);
